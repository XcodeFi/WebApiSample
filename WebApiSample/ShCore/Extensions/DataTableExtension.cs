...
namespace ShCore.Extensions
{
    ...
    public static class DataTableExtension
    {
        ...
        /// <returns></returns>
        public static List<T> ToList<T>(this DataTable table, bool ignoreCase, Action<DataRow, T> action = null) where T : new()
        {
        ...
        /// <returns></returns>
        public static IEnumerable<T> Cast<T>(this DataTable table, bool ignoreCase, Action<DataRow, T> action = null) where T : new()
        {
