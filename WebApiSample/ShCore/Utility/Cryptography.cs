...
namespace ShCore.Utility
{
    ...
    {
        #region RSA Public _ Private Key

        public static string EnCryptByRSA(string inputString, int dwKeySize, string xmlString)
        {
        ...
        public static string DeCryptByRSA(string inputString, int dwKeySize, string xmlString)
        {
            // TODO: Add Proper Exception Handlers
            RSACryptoServiceProvider rsaCryptoServiceProvider = new RSACryptoServiceProvider(dwKeySize);
            rsaCryptoServiceProvider.FromXmlString(xmlString);
        ...
        // Java : http://eternusuk.blogspot.com/2008/09/java-triple-des-example.html
